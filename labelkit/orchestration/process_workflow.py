...
class ProcessWorkflow:
    ...
    def _print_sequence_estimate(sequence: Mapping) -> None:
        ...
        print(
            ...
            f"interleaving_opportunities={sequence['interleaving_opportunities']} "
            f"primary_sessions={sequence['primary_sessions']} "
            f"interleaved_primary_sessions={sequence['interleaved_primary_sessions']} "
