...
| 测试 | 新增 extensions/config/inference 的 postprocessing 测试；扩充 config（包括 `test_paths_hooks.py`）、generation contracts、annotate、verify、program、planner、project、sequence workflow、emitter 与 CLI 测试；新增 `tests/operators/test_postprocessing_examples.py` | 覆盖验收矩阵全部行为和反例；加强最终行、retained bytes、摘要与 manifest 的已有用例；CLI 检查退出码 4 及精确源码/测试文件清单；隔离 worktree 基线不得依赖 checkout 绝对路径或错误格式化期间仍有效的环境拦截 |
...
| 验收项 | 已执行的测试函数 |
|---|---|
| 工程根相对加载 | [test_global_hook_is_frozen_project_relative_without_any_startup_business_call](../../tests/common/config/test_postprocessing_config.py#L64)；[test_two_projects_with_same_hook_filename_keep_distinct_frozen_callables](../../tests/common/extensions/test_postprocessing.py#L356) |
| 四种入口与覆盖 | [test_record_class_override_and_inheritance_keep_reference_and_target_together](../../tests/common/config/test_postprocessing_config.py#L118)；[test_frame_global_and_class_overrides_freeze_shared_projection](../../tests/common/config/test_postprocessing_config.py#L160) |
| 同步严格签名 | [test_resolver_rejects_non_sync_or_non_exact_signatures](../../tests/common/extensions/test_postprocessing.py#L381)；[test_record_default_must_be_none_by_identity_without_invoking_equality](../../tests/common/extensions/test_postprocessing.py#L411)；[test_resolved_postprocessor_reference_and_callable_are_immutable](../../tests/common/extensions/test_postprocessing.py#L345) |
| 无虚构调用 | [test_global_hook_is_frozen_project_relative_without_any_startup_business_call](../../tests/common/config/test_postprocessing_config.py#L64)；[test_temporal_fewshot_omits_framework_time_but_requires_code_fields](../../tests/common/config/test_postprocessing_config.py#L511)；[test_keyless_static_load_succeeds_and_reads_no_env_values](../../tests/common/config/test_paths_hooks.py#L108) |
| 内部字段拒绝 | [test_internal_frozen_fields_are_errors_in_every_annotation_namespace](../../tests/common/config/test_postprocessing_config.py#L230)；[test_output_alias_and_root_internal_schema_fields_are_rejected](../../tests/common/config/test_postprocessing_config.py#L271) |
| Schema 原样使用 | [test_unmarked_schemas_and_unaffected_siblings_remain_unchanged](../../tests/common/extensions/test_postprocessing.py#L116)；[test_global_record_postprocessor_normalizes_and_isolates_raw_and_result](../../tests/operators/test_annotate.py#L2246) |
| 必填代码字段 | [test_items_projection_removes_required_code_fields_and_rejects_provider_values](../../tests/common/extensions/test_postprocessing.py#L35)；[test_enabled_class_and_frame_schemas_require_their_effective_postprocessor](../../tests/common/config/test_postprocessing_config.py#L288) |
| 实体数组与可选父节点 | [test_nested_arrays_optional_nullable_parents_and_empty_objects](../../tests/common/extensions/test_postprocessing.py#L63) |
| 投影反例 | [test_open_direct_object_is_rejected_without_closing_other_ancestors](../../tests/common/extensions/test_postprocessing.py#L141)；[test_affected_object_constraints_rejected](../../tests/common/extensions/test_postprocessing.py#L158)；[test_affected_array_constraints_rejected](../../tests/common/extensions/test_postprocessing.py#L168)；[test_marker_requires_supported_property_route](../../tests/common/extensions/test_postprocessing.py#L189)；[test_marker_value_is_strict_json_true](../../tests/common/extensions/test_postprocessing.py#L176) |
| 数据键与目标子树 | [test_default_examples_projection_and_same_named_data_are_preserved](../../tests/common/extensions/test_postprocessing.py#L85)；[test_enum_data_key_named_marker_is_preserved_with_and_without_projection](../../tests/common/extensions/test_postprocessing.py#L102)；[test_whole_marked_property_can_have_complex_final_schema](../../tests/common/extensions/test_postprocessing.py#L131) |
| 时间交叉 | [test_code_time_target_overlap_is_rejected_before_time_projection](../../tests/common/config/test_postprocessing_config.py#L527)；[test_postprocessor_cannot_write_framework_time](../../tests/operators/test_annotate.py#L2361)；[test_sequence_postprocessor_gets_none_before_mechanical_time_injection](../../tests/operators/test_annotate.py#L2305) |
| few-shot 完整性 | [test_fewshot_expected_output_must_include_required_code_fields](../../tests/common/config/test_postprocessing_config.py#L182)；[test_model_budget_omits_large_code_owned_fewshot_in_every_namespace](../../tests/common/config/test_postprocessing_config.py#L411)；[test_fewshot_code_owned_values_must_satisfy_final_constraints](../../tests/common/config/test_postprocessing_config.py#L200) |
...
| 原始上下文 | [test_global_record_postprocessor_normalizes_and_isolates_raw_and_result](../../tests/operators/test_annotate.py#L2246)；[test_sequence_postprocessor_gets_none_before_mechanical_time_injection](../../tests/operators/test_annotate.py#L2305)；[test_frame_global_and_class_postprocessors_use_real_member_raw](../../tests/operators/test_annotate.py#L2456)；[test_missing_raw_remains_distinct_from_an_empty_raw_object](../../tests/common/extensions/test_postprocessing.py#L278) |
| 返回边界 | [test_invalid_returns_fail_with_fixed_internal_error](../../tests/common/extensions/test_postprocessing.py#L292)；[test_cycles_fail_but_shared_references_are_copied_independently](../../tests/common/extensions/test_postprocessing.py#L301)；[test_exception_and_bad_input_never_leak_business_data](../../tests/common/extensions/test_postprocessing.py#L316)；[test_returned_object_completely_replaces_candidate_without_implicit_merge](../../tests/common/extensions/test_postprocessing.py#L264) |
| 校验器隔离 | [test_complete_validated_deeply_isolates_validator_candidate_and_record](../../tests/common/inference/test_postprocessing_schema_engine.py#L96)；[test_complete_validated_l3_gives_each_validator_call_fresh_deep_copies](../../tests/common/inference/test_postprocessing_schema_engine.py#L116)；[test_fewshot_validator_cannot_mutate_nested_expected_output](../../tests/common/config/test_postprocessing_config.py#L332) |
| 自洽采样 | [test_self_consistency_votes_model_fields_and_does_not_rerun_postprocessor](../../tests/operators/test_annotate.py#L2393) |
| L3 与 verify 修复 | [test_complete_finalized_l3_processes_each_new_candidate_once](../../tests/common/inference/test_postprocessing_schema_engine.py#L181)；[test_verify_repair_projection_and_budget_use_the_same_model_schema](../../tests/operators/test_annotate.py#L2419)；[test_leaf_repair_projects_previous_time_and_uses_same_finalizer](../../tests/operators/test_annotate.py#L2094)；[test_verify_judge_receives_complete_annotation_with_code_owned_field](../../tests/operators/test_verify.py#L2850) |
| 帧类与补标注 | [test_frame_global_and_class_postprocessors_use_real_member_raw](../../tests/operators/test_annotate.py#L2456)；[test_stream_frame_backfill_final_schema_error_is_attempt_fatal](../../tests/operators/test_verify.py#L3386) |
| 程序错误隔离 | [test_postprocessor_error_isolates_one_record_and_keeps_sibling](../../tests/operators/test_annotate.py#L2577)；[test_postprocessor_error_on_repair_candidate_is_terminal_and_unwrapped](../../tests/common/inference/test_postprocessing_schema_engine.py#L226) |
| 序列致命传播 | [test_stream_episode_repair_postprocessor_error_is_attempt_fatal](../../tests/operators/test_verify.py#L3354)；[test_stream_episode_repair_final_schema_error_is_attempt_fatal](../../tests/operators/test_verify.py#L3371)；[test_terminal_primary_failure_never_consumes_or_retries](../../tests/orchestration/test_sequence_workflow.py#L1464)；[test_public_terminal_failure_preserves_success_artifacts_and_writes_only_failure](../../tests/orchestration/test_sequence_workflow.py#L2191)；[test_sequence_attempt_postprocessor_error_escapes_real_annotation_boundaries](../../tests/operators/test_annotate.py#L2838) |
| 序列冻结 | [test_program_freezes_temporal_frame_and_model_schema_carriers](../../tests/operators/generation/test_program.py#L364)；[test_downstream_barriers_bind_only_frozen_program_views](../../tests/orchestration/test_sequence_workflow.py#L433)；[test_global_full_schemas_are_deeply_frozen_and_isolated_from_loader_sources](../../tests/common/config/test_postprocessing_config.py#L85)；[test_program_digest_includes_postprocessor_reference_but_not_callable](../../tests/operators/generation/test_program.py#L132)；[test_record_class_full_schema_is_deeply_frozen](../../tests/common/config/test_postprocessing_config.py#L142) |
| 组回滚与计数 | [test_annotate_attempt_seam_propagates_terminal_errors_without_dataset_commit](../../tests/operators/test_annotate.py#L2723)；[test_frontier_internal_error_discards_without_group_commit](../../tests/orchestration/test_sequence_workflow.py#L1071)；[test_successful_group_commit_never_discards_consumed_reservation](../../tests/orchestration/test_sequence_workflow.py#L1086)；[test_sequence_attempt_postprocessor_error_escapes_real_annotation_boundaries](../../tests/operators/test_annotate.py#L2838)；[test_public_terminal_failure_preserves_success_artifacts_and_writes_only_failure](../../tests/orchestration/test_sequence_workflow.py#L2191) |
| 最终交付 | [test_sequence_assembly_uses_final_item_for_every_output_byte](../../tests/operators/test_emitter.py#L1818)；[test_sequence_prepare_and_commit_use_one_digest_and_manifest_last](../../tests/operators/test_emitter.py#L2118)；[test_real_local_postprocessing_delivery](../../tests/integration/test_postprocessing_local_llm.py#L214)；[test_prepared_digest_changes_with_final_postprocessor_fields](../../tests/orchestration/test_sequence_workflow.py#L984)；[test_delivery_digest_and_manifest_hash_cover_rebound_temporal_content](../../tests/operators/test_emitter.py#L2082)；[test_primary_candidate_and_capacity_include_projected_replay_bytes](../../tests/orchestration/test_sequence_workflow.py#L1627) |
| 关闭行为与预算 | [test_frame_only_attempt_has_zero_sequence_calls_and_accepts_all_members](../../tests/operators/test_annotate.py#L2925)；[test_verify_repair_projection_and_budget_use_the_same_model_schema](../../tests/operators/test_annotate.py#L2419)；[test_model_budget_omits_code_owned_schema_content](../../tests/common/config/test_postprocessing_config.py#L348)；[test_frame_without_postprocessor_skips_user_validator_and_resolved_at](../../tests/operators/test_annotate.py#L1452)；[test_frame_prompt_response_schema_and_budget_use_model_frame_schema](../../tests/operators/test_annotate.py#L2522)；[test_class_static_budget_uses_its_projected_model_schema](../../tests/common/config/test_postprocessing_config.py#L356)；[test_frame_static_budget_uses_its_projected_model_schema](../../tests/common/config/test_postprocessing_config.py#L384) |
...
| `labelkit/orchestration/sequence_workflow.py` | 90.05% | 83.33% |

生产代码及实际运行的示例钩子、检查器通过文件长度、函数长度、调用参数和行宽检查；新增接口使用中文
Doxygen 注释。`git diff --check` 与 AGENTS/CLAUDE 字节一致检查通过。Ruff 的 E4/E7/E9/F 检查使用 Python 3.12
目标版本，与 `9f88620` 比较没有新增诊断；
