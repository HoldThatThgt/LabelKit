"""Offline unit tests for M3 dedup (labelkit/dedup.py) — pure logic only, no LLM.
...
from labelkit.types import ImageRef, PipelineItem, Record, RecordRef, UINode, UITree
